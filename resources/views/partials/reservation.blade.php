<section id="services" class="services">
    <div class="container">
        <div class="form-group">
            ...
            <input type="text" name="ingress" id="ingress" class="form-control" class="datepicker">
        </div>
        <div class="section-title" data-aos="fade-in" data-aos-delay="100">
            <h2 style="color:#69a817;"><i class="fa-solid fa-map-location-dot"></i> Encuentra tu próxima parada</h2>
            <p>Contamos con 4 tipos de cabaña que se ajustaran a la medida de tus deseos, para la familia, en pareja o
                simplemente pasar un fin de semana en solitario para descansa el cuerpo, mente y alma.</p>
        </div>
        <div class="row">
                ...
                <div class="col-md-6 col-lg-3 d-flex align-items-stretch mb-5 mb-lg-0">
                    <div class="icon-box border" data-aos="fade-up">
                        ...
                        <i class="fa-solid fa-toilet"
                            style="color:#69a817;"><label>&nbsp;{{ $cottage->toilets }}</label> </i>&nbsp;
                        <i class="fa-solid fa-bed" style="color:#69a817;"><label>&nbsp;{{ $cottage->beedrooms }}</label>
                        </i>
                        <a id="links" href="" class="ms-3">Más detalles</a>
                        <img src="{{ asset('img/' . $cottage->image . '') }}" class="img-fluid border rounded mb-3 mt-3"
                            alt="">
                        <div class="row">
                            <div class="col">
                                <h3 id="precio" style="color:#69a817;"><strong><i
                                            class="fa-solid fa-dollar-sign"></i>&nbsp;{{ $cottage->price }}</strong>
                                </h3>
                            </div>
                        ...
                        <button id="boton" class="btn btn-success col-md-12" data-bs-toggle="modal"
                            data-bs-target="#cottageBooking{{ $cottage->id }}"><strong>RESERVAR</strong></button>
                    </div>
                </div>
                <!-- Modal para Reservar Cabaña -->
                <div class="modal fade" id="cottageBooking{{ $cottage->id }}" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <div class="row">
                                    <div class="col-md-12">
                                        <h4 class="modal-title" id=""><i class="bi bi-clipboard-check"></i> Tu
                                            reserva</h4>
                                    </div>
                                    <div class="col">
                                        <a>{{ $cottage->name }}</a>
                            ...
                            <div class="modal-body" data-aos="fade-up">
                                <div class="col-lg-20">
                                    <form action="{{ route('detail', ['cottage' => $cottage->id]) }}" method="POST">
                                        @csrf
                                        <input id="cottageId" name="cottageId" type="hidden"
                                            value="{{ $cottage->id }}">
                                        <input type="hidden" name="cottageImg"
                                            value="{{ asset('img/' . $cottage->image . '') }}">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="egress" id="egress"
                                                        class="form-control" class="datepicker">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row mt-3">
                                            ...
                                            <div class="col-md-6 form-group mt-3 mt-md-0">
                                                ...
                                                <input type="text" class="form-control" name="lastname"
                                                    id="lastname" placeholder="Apellidos" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 form-group mt-3">
                                                ...
                                                <input type="text" name="city" class="form-control"
                                                    id="city" placeholder="Ciudad" required>
                                            </div>
                                            <div class="col-md-6 form-group mt-3">
                                        ...
                                        <div class="form-group mt-3 ">
                                            ...
                                            <input type="text" class="form-control" name="phone" id="phone"
                                                placeholder="Telefono ej.(+569xxxxxxxx)" value="+56 " required>
                                        </div>
                                        <div class="row">
                                            <a href="" id="links" class="text-center mt-3">¿Por qué te
                                                pedimos estos datos?</a>
                                        </div>
                                        <div class="row">
                                            ...
                                            <div class="col col-md-12 form-group mt-3" style="text-align:center;">
                                                <button id="boton" type="submit"
                                                    class="btn btn-success btn-primary col-md-12"><strong>Continuar</strong></button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
...
@section('scripts')
    <script type="module">
      var date_range = {!! json_encode($dates) !!};
      $("#ingress").datepicker({
