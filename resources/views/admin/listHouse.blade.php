...
<section class="section dashboard">
    <div class="pagetitle">
        <h1>Lista Cabañas Arrendadas</h1>
        <nav>
            <ol class="breadcrumb">
                <li class="breadcrumb-item active">/ dashboard / ListaCabañas</li>
            </ol>
        </nav>
    </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <form action="" method="POST">
                                                    <a class="btn btn-sm btn-primary " href=""><i class="fa fa-fw fa-eye"></i> Ver</a>
